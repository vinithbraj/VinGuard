...
{\
	slacksoft::block _block((LPVOID)&_data,0,&slacksoft::functors::out::_s_cstring,&slacksoft::functors::in::_d_cstring);\
	_blocks.push_back(_block);\
}

#define SERIALIZE_MAP_ENTRY_ATL_CSTRING_VECTOR(_data)\
{\
	slacksoft::block _block((LPVOID)&_data,0,&slacksoft::functors::out::_s_cstring_vector,&slacksoft::functors::in::_d_cstring_vector);\
	_blocks.push_back(_block);\
}

#define SERIALIZE_MAP_ENTRY_STD_STRING(_data)\
{\
	slacksoft::block _block((LPVOID)&_data,0,&slacksoft::functors::out::_s_stdstring,&slacksoft::functors::in::_d_stdstring);\
	_blocks.push_back(_block);\
}

#define SERIALIZE_MAP_ENTRY_POD(_type,_data)\
{\
	slacksoft::block _block((LPVOID)&_data,0,&slacksoft::functors::out::_s_pod<_type>,&slacksoft::functors::in::_d_pod<_type>);\
	_blocks.push_back(_block);\
}

#define SERIALIZE_MAP_ENTRY_BYTE( _type, _data, _size )\
{\
	slacksoft::block _block((LPVOID)&_data, _type, _size,slacksoft::functors::out::_s_byte,slacksoft::functors::out::_d_byte);\
	_blocks.push_back(_block);\
}
